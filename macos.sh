...
LanguageRegion() {
  :
	...
	defaults write .GlobalPreferences AppleLanguages -array ja en
...
Network() {
  :
	...
	# [[ -z ${IS_AIRPORT} ]] && /usr/libexec/PlistBuddy -c "Add menuExtras \"/System/Library/CoreServices/Menu
  # Extras/AirPort.menu\"" ${HOME}/Library/Preferences/com.apple.systemuiserver.plist
	# - Unchecked
	# IS_AIRPORT=$(defaults read com.apple.systemuiserver menuExtras | grep "AirPort")
...
DateTime() {
  :
	...
	# ========== Show date ==========
	# - Checked
	defaults write com.apple.menuextra.clock DateFormat -string "MMM d EEE HH:mm:ss"
	# - Unchecked
	# defaults write com.apple.menuextra.clock DateFormat -string "HH:mm"
}
